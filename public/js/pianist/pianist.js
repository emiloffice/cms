...
function shareScoreUsingFbui(msg) {
  try {
    var obj = {
      method: 'feed',
      link: "apps.facebook.com/iampianist",
      picture: "http://raiderbear-6a1.kxcdn.com/piano/images/og_keys_1500.jpg",
      name: msg,
      caption: "Play I Am Pianist!",
      actions: [
        {'name': 'Play I Am Pianist!', 'link': 'https://apps.facebook.com/iampianist'}
      ]
    };
...
function gaTrack(category, message) {
  try {
    var game_key = '2f4477c3fedf3c80b06dcd761e2634b5';
    var secret_key = '6ecac6c61ab68df2ca48f98276db106b92fe0567';
