...
function getFbUserInfo() {
  $("#SimpleSwf")[0].returnFbUserInfo(window.dm2048FirstName, window.dm2048LastName, "Unknown", window.dm2048TestGroup);
}
...
/**
 * Share tile merging stories to facebook open graph
 */
function doShareOpenGraphCreate(tileValue) {
  var tileUrl = "http://www.dm2048.com/dm2048/ogtile/" + tileValue;
  FB.api('/me/gominions:create', 'post', {tile: tileUrl}, function(response) {
    console.log(response);
  });
}
...
function inviteFriends() {
  FB.ui({method: 'apprequests',
    message: "Can you get to the legendary Mega Jewel?",
    title: "Play 2048 Jewels!"
  }, function(response) {
...
function shareScoreUsingFbui(msg) {
  var obj = {
    method: 'feed',
    link: "apps.facebook.com/gominions",
    picture: "http://raiderbear-6a1.kxcdn.com/snaps/dm_board_1500.jpg",
    name: msg,
    caption: "Despicable Me: 2048",
    actions: [
      {'name': 'Play 2048!', 'link': 'https://apps.facebook.com/gominions'}
    ]
  };
