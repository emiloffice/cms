export default {
    ...
    games:[
        {name:'《寻求黎明》',cover:"/images/m_seekingdawn_thumb.png",cover_alt:'寻求黎明', des:'Seeking Dawn是由Multiverse制作的大型科幻RPG类VR/PC游戏，游戏具有丰富的合成玩法和生存元素，带你进入身临其境的外星人“死亡世界”。 如何利用好各种各样的道具和建筑在游戏中生存下去，并且一步步去探索揭开这个神秘星球的真面目。',link:'#',video:"http://player.youku.com/embed/XMjc1MTgwNTYxMg=="},
        {name:'《梦幻风之旅》',cover:'/images/thumb4.png',cover_alt:'梦幻风之旅', des:'《梦幻风之旅》Dream Flight是一款让你尽情享受充满梦幻虚拟世界的美丽游戏。驾驶着纸飞机的小姑娘，穿越充满魔力的梦幻世界，寻找失散的同伴。不需要手柄，也没有血腥的厮杀，Dream Flight让你彻底陶醉在充满艺术感的视听盛宴中。。',link:'#',video:"http://player.youku.com/embed/XMjEyMjIzMzAzMg=="},
        {name:'《特工22号：越狱》',cover:'/images/thumb2.png',cover_alt:'特工22号：越狱', des:'《特工22号:越狱》是一款VR密室逃脱游戏，22号特工身陷牢笼，不过这显然不是22号第一次经历越狱，找寻一切可能用得上的道具做好出逃准备吧，当然你也得避开一些危险。作为一款带有探索解密性质的VR游戏，这款游戏上手容易，操作简单，解密难度逐渐增强，非常适合喜欢解密探索元素的玩家。如果较长时间没有解锁关卡，游戏中即可获得提示线索，让轻度玩家也能愉快畅玩。《特工22:越狱》由法国团队XXCII开发，Multiverse发行。',link:'#',video:"http://player.youku.com/embed/XMzEzOTAyNzQ2NA=="},
        {name:'《圣域纷争》',cover:'/images/thumb3.png',cover_alt:'圣域纷争', des:'《圣域纷争》是由深圳火花幻境研发，Multiverse发行的一款塔防类VR游戏。玩家需要在游戏中扮演一名孤胆英雄，利用好陷阱和道具面对敌人，通过陷阱阻止他们前行守护最后的圣域。',link:'#',video:"http://player.youku.com/embed/XMjc5ODE0MTg3Ng=="},
        {name:'《银河穿梭VR》',cover:'/images/thumb5.png',cover_alt:'银河穿梭VR', des:'《银河穿梭VR》是一款VR跑酷类游戏，玩家仿佛星际穿梭一般，穿越了时空的界限，在充满次世代的音乐背景中极速飞行!富含科幻感的时空隧道内，你需要高度集中注意力，紧盯着路径上的红点，随时躲避前方的障碍物。',link:'#',video:""},
    ],
    work_view:{
        env_title:"公司环境、氛围",
        env_des:"一家充满神秘并且其乐无穷的跨国游戏公司正向你开启光明的大门",
        culture_title:"企业文化",
        culture_des:"Multiverse以游戏为核心，研发各种以游戏性和目标的游戏。我们以打造最好的游戏为目标，并且持之以恒的行动着。",
        hardware_title:"优越的硬件设备",
        hardware_des:"对于一个互联网公司，优越的硬件自然是不可缺少。对于不同的职位我们将提供不同级别的硬件，但是作为一家游戏爱好者聚集的公司，我们能够保证的是所有人都能流畅的去体验目前的热门作品。",
        history_img:"/images/history_bg.png"
    },
    job_view:[
        {img_src:"/images/job1.png", des:"                        一家充满神秘并且其乐无穷的跨国游戏公司正向您开启光明的大门<br/>\n" +
        "                        我们允许你可以自己做产品经理！<br/>\n" +
        "                        我们让你自主决定技术架构及工作方法！<br/>\n" +
        "                        我们听取你任何好的想法，从无限制！<br/>\n" +
        "                        我们让工作变成一件令人享受的事情！<br/>"},
        {img_src:"/images/job3.png", des:"                        吃不完的零食！（啊？）<br/>\n" +
        "                        喝不完的饮料！（什么？）<br/>\n" +
        "                        自由自在的工作环境！（真的吗？）<br/>\n" +
        "                        优厚的待遇！（Really？）<br/>\n" +
        "                        延长的假期！（哇喔？）<br/>\n" +
        "                        巨大的升迁空间而且还没有办公室政治！（WTF？）<br/>"},
        {img_src:"/images/job2.png", des:"                        如果您牛到以下程度：<br>\n" +
        "                        ·3年以上游戏相关经验；<br>\n" +
        "                        ·经历过完整的游戏研发项目；<br>\n" +
        "                        ·吃苦耐劳、乐于奉献、团队意识强。<br>\n" +
        "                        既然您对自己辣么有信心，那还等什么？<br>\n" +
        "                        这里就是您转变人生的地方！快到碗里来！！！！<br>\n" +
        "                        然鹅：    我们只招最优秀的人才!\<br>\n" +
        "                        我需要您！！！I want you!!! （一？按钮呢？？？）\<br>"},
        {img_src:"/images/job4.png", des:"                        我们需要您到碗里来：<br>\n" +
        "                        ·自主决定工作方法<br>\n" +
        "                        ·预留充足时间用于学习新技术<br>\n" +
        "                        ·加强团队成员间正能量沟通<br>\n" +
    ...
    about_view:{
        intro:" <span>深圳市摩登世纪科技有限公司是一家专业VR/PC/手游提供商内容游戏开发和发行工作室。我们是一家世界级的虚拟现实内容研发企业。团队成员毕业于斯坦福大学、卡内基梅隆、Darden商学院等世界知名学府，并拥有Wevr、迪士尼、Riot（英雄联盟）、CJ E&M、银汉（时空枪战）、SGN等顶尖VR及游戏企业的经历。团队的上一款产品《Reveries: Dream Flight》是目前全球评分最高的国产VR游戏。开发中的大型新游戏项目《Seeking Dawn》获得腾讯VR开发者大赛最佳视觉奖。</span>\n" +
        "                            <p>· 我们的愿景</p>\n" +
        "                            <span> 我们希望能够成为世界顶尖的游戏开发商，做出能够风靡世界的3A游戏，为中国游戏的崛起做出努力。</span>\n" +
        "                            <p>·  公司环境、氛围</p>\n" +
        "                            <span> 一家充满神秘并且其乐无穷的跨国游戏公司正向你开启光明的大门。</span>\n" +
        "                            <p>· 我们的价值观</p>\n" +
        "                            <span>我们的价值观是做好玩的游戏，至始至终以游戏性为目的去研发游戏，做顶尖的和精品的游戏。</span>",
        story:"Multiverse立足于深圳，将目光看向世界，成立之初的产品《Dream Flight》获得了国产移动VR游戏在Gear VR平台上的最好评分。第二款研发的大型VR游戏《Seeking Dawn》在开发中期就获得了腾讯GAD开发大赛最佳视觉奖。在开发过程中接受UNITY公司邀请，前往VISION大会进行演讲。\n" +
