export default {
    ...
    games:[
        {name:'《寻求黎明》',cover:"/images/seekingdawn.jpg",cover_alt:'寻求黎明', des:'Seeking Dawn是由深圳市摩登世纪科技有限公司（Multiverse）制作的大型科幻RPG类VR/PC游戏，游戏具有丰富的合成玩法和生存元素，带你进入身临其境的外星死亡世界。 玩家需要利用好各种各样的道具和建造系统在游戏中生存下去，并且一步步去探索揭开这个神秘星球的真面目。',link:'https://www.seekingdawn.com',video:"https://player.youku.com/embed/XMjc1MTgwNTYxMg==",isPlay:true},
    ...
    work_view:{
        ...
        culture_des:"始终以技术和内容创新为核心，始终以玩家体验为核心，始终以游戏梦想为核心。",
        hardware_title:"公司的硬件设备",
        hardware_des:"作为一个互联网游戏公司，先进的硬件自然是不可缺少。对于不同的职位，我们将提供不同的硬件以满足工作需求。但是作为一家游戏爱好者聚集的公司，我们能够保证的是所有人都能流畅地去体验所有热门游戏作品。",
        history_img:"/images/history_bg.png",
        vision_title:"我们的愿景",
        vision_des:"我们希望能够成为世界顶尖的游戏开发商和发行商，做出能够风靡世界的3A游戏。为中国游戏的崛起做出努力，为世界游戏行业锦上添花。",
        value_title:"我们的价值观",
        value_des:"始终以技术和内容创新为核心，始终以玩家体验为核心，始终以游戏梦想为核心。"
    },
    job_view:[
    ...
    index_view:{
        about_des:"                    <p class=\"title\">我们的愿景</p>\n" +
            "                    <p>我们希望能够成为世界顶尖的游戏开发商和发行商，做出能够风靡世界的3A游戏。为中国游戏的崛起做出努力，为世界游戏行业锦上添花。</p>\n" +
            "                    <p class=\"title\">我们的价值观</p>\n" +
            "                    <p>始终以技术和内容创新为核心，始终以玩家体验为核心，始终以游戏梦想为核心。</p>\n",
