export default {
    ...
    games:[
        {name:'《寻求黎明》',cover:"/images/seekingdawn.jpg",cover_alt:'寻求黎明', des:'Seeking Dawn是由Multiverse制作的大型科幻RPG类VR/PC游戏，游戏具有丰富的合成玩法和生存元素，带你进入身临其境的外星人“死亡世界”。 如何利用好各种各样的道具和建筑在游戏中生存下去，并且一步步去探索揭开这个神秘星球的真面目。',link:'#',video:"http://player.youku.com/embed/XMjc1MTgwNTYxMg==",isPlay:true},
        ...
        {name:'《圣域纷争》',cover:'/images/thumb3.jpg',cover_alt:'圣域纷争', des:'《圣域纷争》是由深圳火花幻境研发，Multiverse发行的一款塔防类VR游戏。玩家需要在游戏中扮演一名孤胆英雄，利用好陷阱和道具面对敌人，通过陷阱阻止他们前行守护最后的圣域。',link:'#',video:"http://player.youku.com/embed/XMjc5ODE0MTg3Ng==",isPlay:true},
