    ...
    <div class="container-fluid">
        ...
        <ul class="game_list container">
            <li class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="right fl">
                    <p class="name"> 《寻求黎明》</p>
                    <p class="des" style="border: none;margin-top: 0;">
            ...
            <li class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="right fl">
                    <p class="name"> 《特工22号：越狱》</p>
                    <p class="des" style="border: none;margin-top: 0;">《圣域纷争》是由深圳火花幻境研发，Multiverse发行的一款塔防类VR游戏。玩家需要在游戏中扮演一名孤胆英雄，利用好陷阱和道具面对敌人，通过陷阱阻止他们前行守护最后的圣域。</p>
                    <a href="">官方网站</a>
                </div>
            </li>
            <li class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
            ...
            <li class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="right fl">
                    <p class="name"> 《梦幻风之旅》</p>
                    <p class="des"style="border: none;margin-top: 0;">《梦幻风之旅》Dream Flight是一款让你尽情享受充满梦幻虚拟世界的美丽游戏。驾驶着纸飞机的小姑娘，穿越充满魔力的梦幻世界，寻找失散的同伴。不需要手柄，也没有血腥的厮杀，Dream Flight让你彻底陶醉在充满艺术感的视听盛宴中</p>
                    <a href="">官方网站</a>
                </div>
            </li>
            <li class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                ...
                <div class="right fl">
                    <p class="name"> 《银河穿梭VR》</p>
                    <p class="des"style="border: none;margin-top: 0;">《银河穿梭VR》是一款VR跑酷类游戏，玩家仿佛星际穿梭一般，穿越了时空的界限，在充满次世代的音乐背景中极速飞行!富含科幻感的时空隧道内，你需要高度集中注意力，紧盯着路径上的红点，随时躲避前方的障碍物。</p>
                    <a href="">官方网站</a>
                </div>
            </li>
        </ul>
