...
<head>
    ...
    <meta name="description" content="Multiverse Entertainment LLC's legal policies">
    <meta name="DC.title" content="Legal">
    <meta name="robots" content="index,follow">
    <meta name="author" content="">

    <title>Legal - Multiverse Entertainment</title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <div id="wrapper">
        <div id="sidebar-wrapper">
            <ul class="sidebar-nav">
                ...
                <li><a class = "sidebar-link" href="about">Who We Are</a></li>
                <li><a class = "sidebar-link" href="team">Our Team</a></li>
                <li><a class = "sidebar-link" href="values">Our Values</a></li>
                <li><a class = "sidebar-link-active" href="legal">Legal</a></li>
            </ul>
        </div>
    ...
    <!-- Footer -->
    <footer>
        <div class="container text-center col-md-9" style="margin-left: 20px;">
