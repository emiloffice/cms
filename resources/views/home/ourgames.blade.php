...
<head>
    ...
    <meta name="description" content="Find out about all of Multiverse Entertainment's available games here.">
    <meta name="DC.title" content="Our Games">
    <meta name="robots" content="index,follow">
    <meta name="author" content="">

    <title>Our Games - Multiverse Entertainment</title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
   ...
   <!-- Navigation -->
    ...
    <!-- Banner -->
    <div class="banner" style="background-image: url(/img/ourgames-bg.jpg)">
        <div class="container-fluid text-center">
            <div class="row">
                <h1 class="banner-title">Our Games</h1>
            </div>
        </div>
    </div>
    ...
    <section id="games" class="container content-section text-center">
        <div id="games" class="row">
            ...
            <div class="col-lg-8 col-lg-offset-2">
                <div class="col-md-6">
                    <div>
                        <a href="dreamflight"><img src="/img/dreamflight-thumbnail.jpg" style="width: 100%; height: auto;"></a>
                    </div>
                    <div>
                        <a href="dreamflight"><h4 class="table-title">Reveries: Dream Flight</h4></a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div>
                        <a href="https://play.google.com/store/apps/details?id=com.multiverse.galaxyrush&hl=en"><img src="/img/galacticrush-thumbnail.jpg" style="width: 100%; height: auto;"></a>
                    </div>
                    <div>
                        <a href="https://play.google.com/store/apps/details?id=com.multiverse.galaxyrush&hl=en"><h4 class="table-title">Galactic Rush VR</h4></a>
                    </div>
                </div>
                <div class="col-md-12">
                    <div>
                        <a href="https://app-liv.net/innovativ/vr-experience-galactic-rush-vr/"><img src="https://app-liv.net/innovativ/wp-content/uploads/2017/04/innovativ-topapp-color.png" alt="INNOVATIV by Appliv Top App Innovator" border="0" width="200"></a>
                    </div>
                    <div>
                        <a href="https://play.google.com/store/apps/details?id=com.multiverse.galaxyrush&hl=en"><h4 class="table-title">INNOVATIV by Appliv</h4></a>
                    </div>
                </div>
            </div>
        </div>
