...
<head>
    ...
    <meta name="description" content="Edge of the Galaxy: Multiverse's latest upcoming game project.">
    <meta name="DC.title" content="Edge of the Galaxy">
    <meta name="robots" content="index,follow">
    <meta name="author" content="">

    <title>Coming Soon - Multiverse Entertainment</title>
...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <!-- Banner -->
    <div class="banner" style="background-image: url(/img/comingsoon2-bg.jpg)">
        <div class="container-fluid text-center">
            <div class="row">
                <h1 class="banner-title">Coming Soon</h1>
            </div>
        </div>
    </div>
    ...
    <section id="" class="container content-section text-center">
        <div class="row">
            ...
            <h1>Edge of the Galaxy</h1>
            <p><i>Edge of the Galaxy</i> is our third VR game slated for release on Android and Oculus stores.</p>
            <p>Explore deep space and alien surfaces teeming with strange life forms in this on-rails first-person shooter. Simply control where you aim by moving your head, and take out environmental hazards that try to stop your progress.</p> 
            </div>
            <hr class="half">
            <div class="col-lg-8 col-lg-offset-2">
                ...
                <div class="row">
                    <div class="col-md-6 gallery">
                        <a href="/img/gr0.jpg" data-lity><img src="/img/gr0.jpg" class="img-responsive"></a>
                    </div>
                    <div class="col-md-6 gallery">
                        <a href="/img/gr1.jpg" data-lity><img src="/img/gr1.jpg" class="img-responsive"></a>
                    </div>
                    <div class="col-md-6 gallery">
                        <a href="/img/gr2.jpg" data-lity><img src="/img/gr2.jpg" class="img-responsive"></a>
                    </div>
                    <div class="col-md-6 gallery">
                        <a href="/img/gr3.jpg" data-lity><img src="/img/gr3.jpg" class="img-responsive"></a>
                    </div>
                    <div class="col-md-6 gallery">
                        <a href="/img/gr4.jpg" data-lity><img src="/img/gr4.jpg" class="img-responsive"></a>
                    </div>
                    <div class="col-md-6 gallery">
                        <a href="/img/gr5.jpg" data-lity><img src="/img/gr5.jpg" class="img-responsive"></a>
                    </div>
                </div>
            </div>
        </div>
