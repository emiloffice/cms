                    ...
                    @foreach($posts as $post)
                        ...
                        @if($post['status']==1)
                            ...
                            <td class="f-14 td-manage"><a style="text-decoration:none" onClick="article_stop(this,'{{ $post->id }}')" href="javascript:;" title="下架"><i class="Hui-iconfont">&#xe6de;</i></a>
                                <a style="text-decoration:none" class="ml-5" onClick="article_edit('日志编辑','{{url('admin/blog-edit',$post->id,env('HTTPS_REQUEST'))}}','')" href="javascript:;" title="编辑"><i class="Hui-iconfont">&#xe6df;</i></a>
